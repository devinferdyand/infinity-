            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Halaman Galery</h4>
                    </div>
...
<h6>List Galery tb_infinity</h6>
                                    ...
                                    <thead>
                                        <tr>
                                          <th>No</th>
                                            ...
                                            <th scope="col" class="col-sm-9" >Gambar</th>
    ...
    while($tb_infinity = mysqli_fetch_array($query)){
        ...
        echo "<td><img src='uploads/$tb_infinity[gambar] '  width='65%'/></td>";


        echo "<td>";
        echo "<a href='edit-galery.php?id=".$tb_infinity['id']."' class='btn btn-warning'><i class='mdi mdi-box-cutter'></i></a>  ";
        echo "<a href='hapus-galery.php?id=".$tb_infinity['id']."'  class='btn btn-danger text-white'><i class='mdi mdi-delete'></i></a>";
        echo "</td>";
